...
public final class XtService {
    ...
    static byte[] toNative(XtAggregateDeviceParams params) {
        AggregateDeviceParams result = new AggregateDeviceParams();
    ...
    public EnumSet<XtServiceCaps> getCapabilities() {
        EnumSet<Enums.XtServiceCaps> result = EnumSet.noneOf(XtServiceCaps.class);
        Integer flags = handleAssert(XtServiceGetCapabilities(_s));
    ...
    public XtStream aggregateStream(XtAggregateStreamParams params, Object user) {
        ...
        AggregateStreamParams native_ = new AggregateStreamParams();
        int size = Native.getNativeSize(AggregateDeviceParams.ByValue.class);
